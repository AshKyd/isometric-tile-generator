...
},{}],"1Ql7":[function(require,module,exports) {
"use strict";
...
var _default = {
  ...
  computed: {
    edgeHeight: function edgeHeight() {
      return (this.height || this.width) / this.width;
    }
  }
};
exports.default = _default;
        var $a83757 = exports.default || module.exports;
      
      if (typeof $a83757 === 'function') {
        $a83757 = $a83757.options;
      }
    
        /* template */
        Object.assign($a83757, (function () {
          var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',[_c('svg',{ref:"svg",attrs:{"xmlns:rdf":"http://www.w3.org/1999/02/22-rdf-syntax-ns#","xmlns":"http://www.w3.org/2000/svg","width":_vm.width,"height":_vm.width / 2 + _vm.height / 2,"version":"1.1","xmlns:xlink":"http://www.w3.org/1999/xlink"}},[_c('defs',[_c('g',{attrs:{"id":"flat","transform":("matrix(1,-.5,1,.5,0," + (_vm.width / 4) + ")")}},[_c('use',{attrs:{"xlink:href":"#assetTop"}})]),_vm._v(" "),_c('g',{attrs:{"id":"side-left","transform":("matrix(1,0.5,0," + _vm.edgeHeight + ",0," + (_vm.width / 4) + ")")}},[_c('use',{attrs:{"xlink:href":"#assetLeft"}})]),_vm._v(" "),_c('g',{attrs:{"id":"side-right","transform":("matrix(1,-0.5,0," + _vm.edgeHeight + "," + (_vm.width / 2) + "," + (_vm.width / 2) + ")")}},[_c('use',{attrs:{"xlink:href":"#assetRight"}})]),_vm._v(" "),(_vm.assetTop.image)?_c('image',{key:_vm.assetTop.image + 1,attrs:{"id":"assetTop","href":_vm.assetTop.image,"x":"0","y":"0","height":_vm.width/2,"width":_vm.width/2}}):_c('rect',{key:_vm.assetTop.color + 2,attrs:{"id":"assetTop","x":"0","y":"0","fill":_vm.assetTop.color,"height":_vm.width/2,"width":_vm.width/2}}),_vm._v(" "),(_vm.assetLeft.image && _vm.height)?_c('image',{key:_vm.assetLeft.image + 3,attrs:{"id":"assetLeft","href":_vm.assetLeft.image,"x":"0","y":"0","height":_vm.width/2,"width":_vm.width/2}}):_vm._e(),_vm._v(" "),(!_vm.assetLeft.image && _vm.height)?_c('rect',{key:_vm.assetLeft.color + 4,attrs:{"id":"assetLeft","x":"0","y":"0","fill":_vm.assetLeft.color,"height":_vm.width/2,"width":_vm.width/2}}):_vm._e(),_vm._v(" "),(_vm.assetRight.image && _vm.height)?_c('image',{key:_vm.assetRight.image + 5,attrs:{"id":"assetRight","href":_vm.assetRight.image,"x":"0","y":"0","height":_vm.width/2,"width":_vm.width/2}}):_vm._e(),_vm._v(" "),(!_vm.assetRight.image && _vm.height)?_c('rect',{key:_vm.assetRight.color + 6,attrs:{"id":"assetRight","x":"0","y":"0","fill":_vm.assetRight.color,"height":_vm.width/2,"width":_vm.width/2}}):_vm._e()]),_vm._v(" "),_c('g',[_c('use',{attrs:{"x":"0","y":"0","xlink:href":"#flat"}}),_vm._v(" "),_c('use',{attrs:{"x":"0","y":"0","xlink:href":"#side-left"}}),_vm._v(" "),_c('use',{attrs:{"x":"0","y":"0","xlink:href":"#side-right"}})])])])}
var staticRenderFns = []
...
},{}],"KS4z":[function(require,module,exports) {
"use strict";
...
},{}],"oOm1":[function(require,module,exports) {
/**
 * @name getCanvas
...
},{}],"7ZqJ":[function(require,module,exports) {
...
},{"./utils":"oOm1"}],"pBGv":[function(require,module,exports) {
...
},{"./":"Zt7E"}],"tyqG":[function(require,module,exports) {
...
},{}],"llYA":[function(require,module,exports) {
...
},{"es6-promise/auto":"KHzD","./worker":"tyqG"}],"KAEt":[function(require,module,exports) {
var define;
var global = arguments[3];
...
},{}],"Ylh2":[function(require,module,exports) {
module.exports = function _atob(str) {
  return atob(str)
}

},{}],"6wEG":[function(require,module,exports) {
var define;
(function(root) {
  'use strict';
...
},{}],"zJ6x":[function(require,module,exports) {
/**
...
},{"atob-lite":"Ylh2","is-base64":"6wEG"}],"iMMC":[function(require,module,exports) {
...
},{}],"kRNp":[function(require,module,exports) {
/*eslint new-cap:0*/
...
},{"dtype":"iMMC"}],"aFuf":[function(require,module,exports) {
/**
...
},{"string-to-arraybuffer":"zJ6x","flatten-vertex-data":"kRNp"}],"s8zI":[function(require,module,exports) {
...
},{}],"+6DR":[function(require,module,exports) {
/* globals Blob */
'use strict';
...
},{}],"2lP0":[function(require,module,exports) {
/**
...
},{"file-saver":"KAEt","to-array-buffer":"aFuf","simple-mime":"s8zI","is-blob":"+6DR"}],"rdKr":[function(require,module,exports) {
"use strict";
...
exports.svgToDownload = svgToDownload;
exports.getImageBinaryFromSvg = getImageBinaryFromSvg;

var _throttleDebounce = require("throttle-debounce");

var _imageBrightness = _interopRequireDefault(require("image-brightness"));

var imageFilter = _interopRequireWildcard(require("image-filter-core"));

var _saveFile = _interopRequireDefault(require("save-file"));
...
function getImageData(base64Url) {
  return new Promise(function (resolve, reject) {
    ...
    image.onerror = function (e) {
      return reject(new Error("Could not load this image."));
    };
  });
}

var runFiltersThrottled = (0, _throttleDebounce.throttle)(50, function (data, filters, callback) {
  try {
    var newImageData = (0, _imageBrightness.default)({
      data: data,
...
function runFilters(imageData, filters) {
  return new Promise(function (resolve, reject) {
    runFiltersThrottled(imageData, filters, function (err, base64Url) {
...
function getImageBinaryFromSvg(svgString) {
  return new Promise(function (resolve, reject) {
    ...
    image.src = url; // the onerror handler isn't working here for some reason
...
function svgToDownload(svgString) {
  return getImageBinaryFromSvg(svgString).then(function (blob) {
    return (0, _saveFile.default)(blob, "image.png");
  });
}
},{"throttle-debounce":"KS4z","image-brightness":"7ZqJ","image-filter-core":"llYA","save-file":"2lP0"}],"q518":[function(require,module,exports) {
"use strict";
...
//
//
var materialError = function materialError(error) {
...
var _default = {
  ...
  methods: {
    label: function label(name) {
      return "image-asset-picker-".concat(name);
    },
    ...
    drop: function drop(event) {
      this.dragging = false;
      if (event.dataTransfer.files) return this.loadFile(event.dataTransfer.files[0]);
    },
    onFilePick: function onFilePick(event) {
    ...
    loadFile: function loadFile(file) {
      ...
      reader.onload = function (event) {
        (0, _image.getImageData)(event.target.result).then(function (imageData) {
          _this.originalImage = imageData;
          _this.brightness = 0;
          _this.isImage = true;
    ...
    applyFilters: function applyFilters() {
      ...
      if (!this.originalImage) return M.toast({
        html: "Click Load or drag a file onto the preview."
      });
      (0, _image.runFilters)(this.originalImage, {
        brightness: this.brightness
      }).then(function (base64Url) {
        _this2.image = base64Url;
...
exports.default = _default;
        var $e5fe8f = exports.default || module.exports;
      
      if (typeof $e5fe8f === 'function') {
        $e5fe8f = $e5fe8f.options;
      }
    
        /* template */
        Object.assign($e5fe8f, (function () {
          var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"card"},[_c('div',{staticClass:"card-image"},[_c('div',{ref:"dropTarget",staticClass:"image",class:{
        dragging: _vm.dragging
      },style:({
        'background-color': _vm.color,
        'background-image': ("url(" + _vm.image + ")"),
      }),on:{"dragover":function($event){$event.preventDefault();return _vm.dragOver($event)},"dragenter":_vm.dragEnter,"dragleave":_vm.dragLeave,"drop":function($event){$event.preventDefault();return _vm.drop($event)}}}),_vm._v(" "),_c('span',{staticClass:"card-title"},[_vm._v(_vm._s(_vm.name))])]),_vm._v(" "),_c('div',{staticClass:"card-content card-content-no-padding"},[_c('ul',{staticClass:"collection collection-no-padding"},[_c('li',{staticClass:"collection-item switch"},[_c('label',{staticClass:"justify-between"},[_vm._v("\n        Color\n        "),_c('input',{directives:[{name:"model",rawName:"v-model",value:(_vm.isImage),expression:"isImage"}],attrs:{"type":"checkbox"},domProps:{"checked":Array.isArray(_vm.isImage)?_vm._i(_vm.isImage,null)>-1:(_vm.isImage)},on:{"input":_vm.toggleImage,"change":function($event){var $$a=_vm.isImage,$$el=$event.target,$$c=$$el.checked?(true):(false);if(Array.isArray($$a)){var $$v=null,$$i=_vm._i($$a,$$v);if($$el.checked){$$i<0&&(_vm.isImage=$$a.concat([$$v]))}else{$$i>-1&&(_vm.isImage=$$a.slice(0,$$i).concat($$a.slice($$i+1)))}}else{_vm.isImage=$$c}}}}),_vm._v(" "),_c('span',{staticClass:"lever"}),_vm._v("\n        Image\n      ")])]),_vm._v(" "),(_vm.isImage)?_c('li',{staticClass:"collection-item justify-between"},[_c('label',{attrs:{"for":_vm.label('file-picker')}},[_vm._v("File:")]),_vm._v(" "),_c('button',{staticClass:"waves-effect waves-light btn-small",on:{"click":function($event){_vm.$refs.filepicker.click()}}},[_vm._v("Load")]),_vm._v(" "),_c('input',{ref:"filepicker",attrs:{"hidden":"","id":_vm.label('file-picker'),"type":"file"},on:{"input":_vm.onFilePick}})]):_vm._e(),_vm._v(" "),(_vm.isImage)?_c('li',{staticClass:"collection-item"},[_c('label',{attrs:{"for":_vm.label('brightness')}},[_vm._v("Brightness:")]),_vm._v(" "),_c('input',{directives:[{name:"model",rawName:"v-model",value:(_vm.brightness),expression:"brightness"}],attrs:{"id":_vm.label('brightness'),"type":"range","min":"-255","max":"255"},domProps:{"value":(_vm.brightness)},on:{"input":_vm.applyFilters,"__r":function($event){_vm.brightness=$event.target.value}}})]):_vm._e(),_vm._v(" "),(!_vm.isImage)?_c('li',{staticClass:"collection-item justify-between"},[_c('label',{attrs:{"for":_vm.label('color-picker')}},[_vm._v("Color picker:")]),_vm._v(" "),_c('input',{directives:[{name:"model",rawName:"v-model",value:(_vm.color),expression:"color"}],attrs:{"id":_vm.label('color-picker'),"type":"color"},domProps:{"value":(_vm.color)},on:{"input":[function($event){if($event.target.composing){ return; }_vm.color=$event.target.value},_vm.onChange]}})]):_vm._e(),_vm._v(" "),(!_vm.isImage)?_c('li',{staticClass:"collection-item"},[_c('label',{attrs:{"for":_vm.label('color-hex')}},[_vm._v("Hex code:")]),_vm._v(" "),_c('input',{directives:[{name:"model",rawName:"v-model",value:(_vm.color),expression:"color"}],attrs:{"id":_vm.label('color-hex'),"type":"text"},domProps:{"value":(_vm.color)},on:{"input":[function($event){if($event.target.composing){ return; }_vm.color=$event.target.value},_vm.onChange]}})]):_vm._e()])])])}
var staticRenderFns = []
          ...
          return {
            ...
            staticRenderFns: staticRenderFns,
            _compiled: true,
            _scopeId: "data-v-e5fe8f",
            functional: undefined
          };
        })());
      
},{"../lib/image.js":"rdKr"}],"tyLK":[function(require,module,exports) {
"use strict";
...
exports.default = _default;
        var $5e9491 = exports.default || module.exports;
      
      if (typeof $5e9491 === 'function') {
        $5e9491 = $5e9491.options;
      }
    
        /* template */
        Object.assign($5e9491, (function () {
          var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"sidebar"},[_c('div',{staticClass:"link form-item"},[_c('label',[_c('input',{directives:[{name:"model",rawName:"v-model",value:(_vm.linkEdges),expression:"linkEdges"}],staticClass:"filled-in",attrs:{"type":"checkbox"},domProps:{"checked":Array.isArray(_vm.linkEdges)?_vm._i(_vm.linkEdges,null)>-1:(_vm.linkEdges)},on:{"change":[function($event){var $$a=_vm.linkEdges,$$el=$event.target,$$c=$$el.checked?(true):(false);if(Array.isArray($$a)){var $$v=null,$$i=_vm._i($$a,$$v);if($$el.checked){$$i<0&&(_vm.linkEdges=$$a.concat([$$v]))}else{$$i>-1&&(_vm.linkEdges=$$a.slice(0,$$i).concat($$a.slice($$i+1)))}}else{_vm.linkEdges=$$c}},_vm.save]}}),_vm._v(" "),_c('span',{staticClass:"sr-only"},[_vm._v("Link edges")])]),_vm._v(" "),_c('label',[_c('input',{directives:[{name:"model",rawName:"v-model",value:(_vm.lockToCube),expression:"lockToCube"}],staticClass:"filled-in",attrs:{"type":"checkbox"},domProps:{"checked":Array.isArray(_vm.lockToCube)?_vm._i(_vm.lockToCube,null)>-1:(_vm.lockToCube)},on:{"change":[function($event){var $$a=_vm.lockToCube,$$el=$event.target,$$c=$$el.checked?(true):(false);if(Array.isArray($$a)){var $$v=null,$$i=_vm._i($$a,$$v);if($$el.checked){$$i<0&&(_vm.lockToCube=$$a.concat([$$v]))}else{$$i>-1&&(_vm.lockToCube=$$a.slice(0,$$i).concat($$a.slice($$i+1)))}}else{_vm.lockToCube=$$c}},_vm.save]}}),_vm._v(" "),_c('span',{staticClass:"sr-only"},[_vm._v("Lock to cube")])])]),_vm._v(" "),_c('div',{staticClass:"dimensions-width form-item"},[_c('label',{attrs:{"for":"width"}},[_vm._v("Size")]),_vm._v(" "),_c('div',{staticClass:"inline"},[_c('input',{directives:[{name:"model",rawName:"v-model",value:(_vm.width),expression:"width"}],attrs:{"type":"range","min":"8","max":"1024","step":"8"},domProps:{"value":(_vm.width)},on:{"__r":function($event){_vm.width=$event.target.value}}}),_vm._v(" "),_c('input',{directives:[{name:"model",rawName:"v-model",value:(_vm.width),expression:"width"}],attrs:{"type":"text","id":"width","name":"width"},domProps:{"value":(_vm.width)},on:{"input":function($event){if($event.target.composing){ return; }_vm.width=$event.target.value}}})])]),_vm._v(" "),(!_vm.lockToCube)?_c('div',{staticClass:"dimensions-height form-item"},[_c('label',{attrs:{"for":"height"}},[_vm._v("Height")]),_vm._v(" "),_c('div',{staticClass:"inline"},[_c('input',{directives:[{name:"model",rawName:"v-model",value:(_vm.height),expression:"height"}],attrs:{"type":"range","min":"0","max":"1024","step":"8"},domProps:{"value":(_vm.height)},on:{"__r":function($event){_vm.height=$event.target.value}}}),_vm._v(" "),_c('input',{directives:[{name:"model",rawName:"v-model",value:(_vm.height),expression:"height"}],attrs:{"type":"text","id":"height","name":"height"},domProps:{"value":(_vm.height)},on:{"input":function($event){if($event.target.composing){ return; }_vm.height=$event.target.value}}})])]):_vm._e(),_vm._v(" "),_c('div',{staticClass:"save"},[_c('button',{staticClass:"btn",on:{"click":function($event){_vm.$emit('save')}}},[_vm._v("Export PNG")])])])}
var staticRenderFns = []
          ...
          return {
            ...
            staticRenderFns: staticRenderFns,
            _compiled: true,
            _scopeId: "data-v-5e9491",
            functional: undefined
          };
        })());
      
},{}],"DQUe":[function(require,module,exports) {
var global = arguments[3];
/**
...
},{}],"x+C/":[function(require,module,exports) {
/**
...
},{}],"H/li":[function(require,module,exports) {
...
},{}],"lmSM":[function(require,module,exports) {
...
},{"hsl-to-rgb-for-reals":"H/li"}],"yfXM":[function(require,module,exports) {
(function() {
...
},{}],"vIdV":[function(require,module,exports) {
...
},{}],"bmxe":[function(require,module,exports) {
...
},{"rgb-to-hsl":"yfXM","hex-to-rgb":"vIdV"}],"2Z6v":[function(require,module,exports) {
'use strict';
...
},{"lodash.flow":"DQUe","lodash.isfunction":"PeJD","lodash.isarray":"x+C/","hsl-to-hex":"lmSM","hex-to-hsl":"bmxe"}],"4DOF":[function(require,module,exports) {
"use strict";
...
var _IsometricTile = _interopRequireDefault(require("./IsometricTile.vue"));

var _ImageAsset = _interopRequireDefault(require("./ImageAsset.vue"));

var _IsometricViewerSidebar = _interopRequireDefault(require("./IsometricViewerSidebar.vue"));
...
var _default = {
  components: {
    IsometricTile: _IsometricTile.default,
    ImageAsset: _ImageAsset.default,
    IsometricViewerSidebar: _IsometricViewerSidebar.default
  },
  data: function data() {
    return {
      assetTop: {
  ...
  methods: {
    save: function save() {
      (0, _image.svgToDownload)(this.svgRef.outerHTML).catch(function (e) {
        return M.toast({
          html: e.message
        });
      });
    ...
    limit: function limit(value) {
      ...
      var style = window.getComputedStyle(this.$refs.preview);
      var size = parseInt(style.height) - 50;
  ...
  computed: {
    backgroundColor: function backgroundColor() {
      ...
      try {
        var color1 = (0, _kewler.color)(baseColor)((0, _kewler.lightness)(-45))((0, _kewler.saturation)(-20))();
...
exports.default = _default;
        var $9e6fa9 = exports.default || module.exports;
      
      if (typeof $9e6fa9 === 'function') {
        $9e6fa9 = $9e6fa9.options;
      }
    
        /* template */
        Object.assign($9e6fa9, (function () {
          var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"isometric-viewer iso-col",style:(_vm.backgroundColor)},[_c('div',{ref:"preview",staticClass:"left-item preview"},[_c('IsometricTile',{attrs:{"width":this.limit(this.sidebar.width),"height":this.limit(_vm.sidebar.lockToCube ? this.sidebar.width : this.sidebar.height),"asset-top":_vm.assetTop,"asset-left":_vm.assetLeft,"asset-right":_vm.sidebar.linkEdges ? _vm.assetLeft : _vm.assetRight},model:{value:(_vm.svgRef),callback:function ($$v) {_vm.svgRef=$$v},expression:"svgRef"}})],1),_vm._v(" "),_c('div',{staticClass:"iso-row z-depth-5"},[_c('div',{staticClass:"asset"},[_c('ImageAsset',{attrs:{"name":"Top","initial-values":_vm.assetTop},model:{value:(_vm.assetTop),callback:function ($$v) {_vm.assetTop=$$v},expression:"assetTop"}})],1),_vm._v(" "),_c('div',{staticClass:"asset"},[_c('ImageAsset',{attrs:{"name":"Left","initial-values":_vm.assetLeft},model:{value:(_vm.assetLeft),callback:function ($$v) {_vm.assetLeft=$$v},expression:"assetLeft"}})],1),_vm._v(" "),_c('div',{staticClass:"asset"},[(!_vm.sidebar.linkEdges)?_c('ImageAsset',{attrs:{"name":"Right","initial-values":_vm.assetRight},model:{value:(_vm.assetRight),callback:function ($$v) {_vm.assetRight=$$v},expression:"assetRight"}}):_vm._e()],1),_vm._v(" "),_c('IsometricViewerSidebar',{on:{"save":_vm.save},model:{value:(_vm.sidebar),callback:function ($$v) {_vm.sidebar=$$v},expression:"sidebar"}})],1)])}
var staticRenderFns = []
          ...
          return {
            ...
            staticRenderFns: staticRenderFns,
            _compiled: true,
            _scopeId: "data-v-9e6fa9",
            functional: undefined
          };
        })());
      
},{"./IsometricTile.vue":"1Ql7","./ImageAsset.vue":"q518","./IsometricViewerSidebar.vue":"tyLK","kewler":"2Z6v","../lib/image":"rdKr"}],"TC+2":[function(require,module,exports) {
"use strict";
...
var _IsometricViewer = _interopRequireDefault(require("./IsometricViewer.vue"));
...
var _default = {
  components: {
    IsometricViewer: _IsometricViewer.default
  }
};
exports.default = _default;
        var $68106d = exports.default || module.exports;
      
      if (typeof $68106d === 'function') {
        $68106d = $68106d.options;
      }
    
        /* template */
        Object.assign($68106d, (function () {
          var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',[_c('div',[_c('IsometricViewer')],1)])}
var staticRenderFns = []
...
},{"./IsometricViewer.vue":"4DOF"}],"Kmah":[function(require,module,exports) {
var define;
var global = arguments[3];
/*!
...
var _materialize = _interopRequireDefault(require("materialize-css/dist/js/materialize.js"));
...
},{"vue":"QPfz","./components/App.vue":"TC+2","materialize-css/dist/js/materialize.js":"Kmah","./sw.js":[["sw.js","NqYy"],"sw.map","NqYy"]}]},{},["Focm"], null)
//# sourceMappingURL=/app/src.6d3083d5.map